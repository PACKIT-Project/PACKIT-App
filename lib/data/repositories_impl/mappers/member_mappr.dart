...
@AutoMappr([
  ...
  MapType<MemberResponseModel, MemberResponse>(),
  MapType<PackitResponseModel<MemberResponseModel>, PackitResponse<MemberResponse>>(),
  MapType<NotificationConfigStatusModel, NotificationConfigStatus>(),
